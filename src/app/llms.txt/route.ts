...
export async function GET() {
  const baseUrl = process.env.NEXT_PUBLIC_SITE_URL || 'https://www.lovehotelsimulatorwiki.wiki'
  const siteName = process.env.NEXT_PUBLIC_SITE_NAME || 'LOVE Hotel Simulator Wiki'
